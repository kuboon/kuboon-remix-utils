// A tiny, dependency-free HTML tokenizer used by the crawler and the static-HTML
// rewriter. It intentionally round-trips HTML comments (see `ParseOptions.comment`)
// so Remix UI hydration markers (`<!-- rmx:h:* -->`) survive parse/serialize.

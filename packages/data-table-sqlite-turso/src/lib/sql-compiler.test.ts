...
describe('turso sql-compiler', () => {
  ...
  describe('select statement', () => {
    ...
    it('compile selected', async () => {
      ...
      assert.deepEqual(compiled, {
        text:
          'select "accounts"."id" as "accountId", "accounts"."email" as "accountEmail" from "accounts"',
        values: [],
      })
    })
    ...
    it('compile inner join', async () => {
      ...
      assert.deepEqual(compiled, {
        text:
          'select * from "accounts" inner join "tasks" on "accounts"."id" = "tasks"."account_id"',
        values: [],
      })
    })
    ...
    it('compile left join', async () => {
      ...
      assert.deepEqual(compiled, {
        text:
          'select * from "accounts" left join "tasks" on "accounts"."id" = "tasks"."account_id"',
        values: [],
      })
    })
    ...
    it('compile right join', async () => {
      ...
      assert.deepEqual(compiled, {
        text:
          'select * from "accounts" right join "tasks" on "accounts"."id" = "tasks"."account_id"',
        values: [],
      })
    })
    ...
    it('compile logical or', async () => {
      ...
      assert.deepEqual(compiled, {
        text:
          'select * from "accounts" where (("accounts"."status" = ?) or ("accounts"."status" = ?))',
    ...
    it('compile nested predicates', async () => {
      ...
      assert.deepEqual(compiled, {
        text:
          'select * from "accounts" where (("accounts"."id" = ?) and (("accounts"."status" = ?) or ("accounts"."status" = ?)))',
  ...
  describe('count - exists statement', () => {
    it('compile count', async () => {
      ...
      assert.deepEqual(compiled, {
        text:
          'select count(*) as "count" from (select 1 from "tasks" where (("account_id" = ?))) as "__dt_count"',
        values: [1],
      })
    })
  ...
  describe('upsert statement', () => {
    ...
    it('compile without update columns', async () => {
      ...
      assert.deepEqual(compiled, {
        text:
          'insert into "accounts" ("status", "email") values (?, ?) on conflict ("id") do nothing',
